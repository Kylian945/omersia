...
@section('title', 'Modifier la zone de taxation')
@section('page-title', 'Modifier la zone de taxation')
...
<div class="space-y-4">
    ...
    <div class="rounded-2xl bg-white border border-black/5 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.settings.taxes.zones.update', $taxZone) }}">
            @csrf
            @method('PUT')
