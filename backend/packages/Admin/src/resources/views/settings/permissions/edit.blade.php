<form action="{{ route('admin.settings.permissions.update', $permission) }}" method="POST" class="space-y-4">
    @csrf
    @method('PUT')

    @include('admin::settings.permissions._form', ['permission' => $permission])
