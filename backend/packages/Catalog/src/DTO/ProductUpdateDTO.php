...
class ProductUpdateDTO
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            sku: $data['sku'] ?? null,
            price: $type === 'simple' ? (isset($data['price']) ? (float) $data['price'] : null) : null,
    ...
    /**
     * Retourne les données pour la mise à jour du produit
     */
    public function toProductArray(): array
    {
        ...
        // Type variant: produit parent sans stock/prix
        return array_merge($payload, [
            'sku' => $this->sku,
            'manage_stock' => false,
            'stock_qty' => 0,
